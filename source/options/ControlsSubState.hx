...
class ControlsSubState extends MusicBeatSubstate
{
	...
	var options:Array<Dynamic> = [
		...
		[true, '5k'],
		[true, 'Left', 'note_five1', 'Note Left'],
		[true, 'Down', 'note_five2', 'Note Down'],
		[true, 'Space', 'note_five3','Note Space'],
		[true, 'Up', 'note_five4', 'Note Up'],
		[true, 'Right', 'note_five5', 'Note Right'],
		[true, '6k'],
		[true, 'Left', 'note_six1', 'Note Left'],
		[true, 'Up', 'note_six2', 'Note Up'],
		[true, 'Right', 'note_six3', 'Note Right'],
		[true, 'Left 1', 'note_six4', 'Note Left 1'],
		[true, 'Down', 'note_six5', 'Note Down'],
		[true, 'Right 1', 'note_six6', 'Note Right 1'],
		[true],
		[true, 'UI'],
